...
def test_parse_literal_string() -> None:
    assert parse_expr('"Hello World"') == Literal("Hello World", start_pos=0, end_pos=13)
...
def test_parse_unary_expr() -> None:
    assert parse_expr("-a") == UnaryExpression(UnaryOperator("-", start_pos=0, end_pos=1), Identifier("a", start_pos=1, end_pos=2), start_pos=0, end_pos=2)
    assert parse_expr("!a") == UnaryExpression(UnaryOperator("!", start_pos=0, end_pos=1), Identifier("a", start_pos=1, end_pos=2), start_pos=0, end_pos=2)


def test_parse_binary_expr() -> None:
    assert parse_expr("a == b") == BinaryExpression(BinaryOperator("==", start_pos=2, end_pos=4), Identifier("a", start_pos=0, end_pos=1), Identifier("b", start_pos=5, end_pos=6), start_pos=0, end_pos=6)
    assert parse_expr("a != b") == BinaryExpression(BinaryOperator("!=", start_pos=2, end_pos=4), Identifier("a", start_pos=0, end_pos=1), Identifier("b", start_pos=5, end_pos=6), start_pos=0, end_pos=6)
    assert parse_expr("a < b") == BinaryExpression(BinaryOperator("<", start_pos=2, end_pos=3), Identifier("a", start_pos=0, end_pos=1), Identifier("b", start_pos=4, end_pos=5), start_pos=0, end_pos=5)
    assert parse_expr("a > b") == BinaryExpression(BinaryOperator(">", start_pos=2, end_pos=3), Identifier("a", start_pos=0, end_pos=1), Identifier("b", start_pos=4, end_pos=5), start_pos=0, end_pos=5)
    assert parse_expr("a <= b") == BinaryExpression(BinaryOperator("<=", start_pos=2, end_pos=4), Identifier("a", start_pos=0, end_pos=1), Identifier("b", start_pos=5, end_pos=6), start_pos=0, end_pos=6)
    assert parse_expr("a >= b") == BinaryExpression(BinaryOperator(">=", start_pos=2, end_pos=4), Identifier("a", start_pos=0, end_pos=1), Identifier("b", start_pos=5, end_pos=6), start_pos=0, end_pos=6)
    assert parse_expr("a - b") == BinaryExpression(BinaryOperator("-", start_pos=2, end_pos=3), Identifier("a", start_pos=0, end_pos=1), Identifier("b", start_pos=4, end_pos=5), start_pos=0, end_pos=5)
...
def test_parse_array_complex() -> None:
    assert parse_expr("[(for), foo, baz]") == Array(
        [
            Parenthesis(
                Identifier("for", start_pos=2, end_pos=5),
...
def test_parse_object() -> None:
    assert parse_expr('{ foo = "bar" }') == Object(
        {Identifier("foo", start_pos=2, end_pos=5): Literal("bar", start_pos=8, end_pos=13)},
        start_pos=0, end_pos=15
    )
    assert parse_expr("{ foo: bar }") == Object(
        {Identifier("foo", start_pos=2, end_pos=5): Identifier("bar", start_pos=7, end_pos=10)},
        start_pos=0, end_pos=12
    )
...
def test_parse_object_complex() -> None:
    assert parse_expr("{ (foo) = bar }") == Object(
        {Parenthesis(Identifier("foo", start_pos=3, end_pos=6), start_pos=2, end_pos=7): Identifier("bar", start_pos=10, end_pos=13)},
        start_pos=0, end_pos=15
    )
    assert parse_expr('{ foo = "bar", baz = 42 }') == Object(
        {
            Identifier("foo", start_pos=2, end_pos=5): Literal("bar", start_pos=8, end_pos=13),
            Identifier("baz", start_pos=15, end_pos=18): Literal(42, start_pos=21, end_pos=23)
        },
    ...
    assert parse_expr('{ "for" = 1, baz = 2}') == Object(
        {
            Literal("for", start_pos=2, end_pos=7): Literal(1, start_pos=10, end_pos=11),
            Identifier("baz", start_pos=13, end_pos=16): Literal(2, start_pos=19, end_pos=20)
        },
        start_pos=0, end_pos=21
    )
    assert parse_expr("{ baz = 2, for = 1}") == Object(
        {
            Identifier("baz", start_pos=2, end_pos=5): Literal(2, start_pos=8, end_pos=9),
            Identifier("for", start_pos=11, end_pos=14): Literal(1, start_pos=17, end_pos=18)
        },
        start_pos=0, end_pos=19
    )
    assert parse_expr("{ (for) = 1, baz = 2}") == Object(
        {
            Parenthesis(Identifier("for", start_pos=3, end_pos=6), start_pos=2, end_pos=7): Literal(1, start_pos=10, end_pos=11),
            Identifier("baz", start_pos=13, end_pos=16): Literal(2, start_pos=19, end_pos=20)
        },
        start_pos=0, end_pos=21
    )
...
def test_parse_get_attr() -> None:
    assert parse_expr("foo.bar") == GetAttr(
        Identifier("foo", start_pos=0, end_pos=3),
        GetAttrKey(
            Identifier("bar", start_pos=4, end_pos=7),
            start_pos=3, end_pos=7
        ),
...
def test_parse_get_index() -> None:
    assert parse_expr("foo[0]") == GetIndex(
        Identifier("foo", start_pos=0, end_pos=3),
        GetIndexKey(
            Literal(0, start_pos=4, end_pos=5),
            start_pos=3, end_pos=6
        ),
        start_pos=0, end_pos=6
    )
...
def test_parse_get_attr_splat() -> None:
    ...
    assert parse_expr("foo.*.bar") == AttrSplat(
        Identifier("foo", start_pos=0, end_pos=3),
        [GetAttrKey(
            Identifier("bar", start_pos=6, end_pos=9),
...
def test_parse_index_splat() -> None:
    ...
    assert parse_expr("foo[*].bar") == IndexSplat(
        Identifier("foo", start_pos=0, end_pos=3),
        [GetAttrKey(
            Identifier("bar", start_pos=7, end_pos=10),
    ...
    assert parse_expr("foo[*].bar[3]") == IndexSplat(
        ...
        [
            ...
            GetIndexKey(
                Literal(3, start_pos=11, end_pos=12),
                start_pos=10, end_pos=13
            )
        ],
...
def test_parse_block() -> None:
    assert parse_module("locals {\na = b\n}") == Module(
        [
            Block(
                ...
                [],
                [Attribute(Identifier("a", start_pos=9, end_pos=10), Identifier("b", start_pos=13, end_pos=14), start_pos=9, end_pos=14)],
                start_pos=0,
                end_pos=16
            ),
        ],
    ...
    assert parse_module("""resource "a" {\na = b\n}""") == Module(
        [Block(
            ...
            [Attribute(Identifier("a", start_pos=15, end_pos=16), Identifier("b", start_pos=19, end_pos=20), start_pos=15, end_pos=20)],
    ...
    assert parse_module("""resource a "b" {\na = b\n}""") == Module(
        [
            Block(
                Identifier("resource", start_pos=0, end_pos=8),
                [Identifier("a", start_pos=9, end_pos=10), Literal("b", start_pos=11, end_pos=14)],
                [Attribute(Identifier("a", start_pos=17, end_pos=18), Identifier("b", start_pos=21, end_pos=22), start_pos=17, end_pos=22)],
    ...
    assert parse_module("""locals {\na = 1\nb = 2\n}""") == Module(
        [Block(
            ...
            [],
            [
                Attribute(Identifier("a", start_pos=9, end_pos=10), Literal(1, start_pos=13, end_pos=14), start_pos=9, end_pos=14),
                Attribute(Identifier("b", start_pos=15, end_pos=16), Literal(2, start_pos=19, end_pos=20), start_pos=15, end_pos=20),
            ],
            start_pos=0, end_pos=22
       )],
        start_pos=0, end_pos=22
    ...
    assert parse_module(
        ...
        body=[
            Block(
               ...
               labels=[],
               body=[Attribute(start_pos=13,
                                   end_pos=26,
                                   key=Identifier(start_pos=13,
                                                  end_pos=18,
                                                  name='value'),
                                   value=Literal(start_pos=21,
                                                 end_pos=26,
                                                 value='foo')
                               )
                     ]
             ...
             Block(start_pos=29,
                   ...
                   body=[Attribute(start_pos=47,
                                   end_pos=57,
                                   key=Identifier(start_pos=47,
                                                  end_pos=52,
                                                  name='value'),
                                   value=Literal(start_pos=55,
                                                 end_pos=57,
                                                 value=42)
                                   )
                         ]
             ...
             Block(start_pos=60,
                   ...
                   labels=[Literal(start_pos=67, end_pos=73, value='arg2'),
                           Identifier(start_pos=74, end_pos=78, name='arg3')],
                   body=[Attribute(start_pos=85,
                                   end_pos=98,
                                   key=Identifier(start_pos=85,
                                                  end_pos=90,
                                                  name='value'),
                                   value=FunctionCall(start_pos=93,
                                                      end_pos=98,
                                                      ident=Identifier(start_pos=93,
                                                                       end_pos=96,
                                                                       name='bar'),
                                                      args=[],
                                                      var_args=False
